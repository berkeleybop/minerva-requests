...
var request_set = function(user_token, model_id){
     ...
     * @param {String} [individual_id] - if none given, generate random one (preferred in most use cases)
     * @param {String} [model_id] - string
	...
	if( typeof(individual_id) === 'string' ){ // optionally add
	    retval = ind_req.individual(individual_id);
